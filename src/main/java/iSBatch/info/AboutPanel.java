...
import iSBatch.controller.MenuItems.WebsiteMenuAction;
import iSBatch.view.LogPanel;
	...
	public AboutPanel(String version) {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					ReportBugMenuAction menu = new ReportBugMenuAction();
					menu.openWebite();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SourceMenuAction menu = new  SourceMenuAction();
				menu.openWebsite();
			}
		});
		...
		btnWebsite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WebsiteMenuAction menu = new WebsiteMenuAction();
				menu.openWebsite();
			}
		});
