 ...
 * 
 */
package operations.cellularConcentration;
...
/**
 * The Class CellularConcentrationGUI.
 */
public class CellularConcentrationGUI extends JDialog implements ActionListener {
	 ...
	 * @param node the node
	 */
	public CellularConcentrationGUI(Node node) {
		setModal(true);
	...
	public static void main(String[] args) {
		...
		new CellularConcentrationGUI(null);
