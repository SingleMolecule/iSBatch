...
public class CopyOfPeakFitterGui extends JDialog implements ActionListener{
...
private String[] types = new String[] { "[File Type]", "Raw", "Flat",
	...
	public CopyOfPeakFitterGui(Node node) {
		setModal(true);
		setTitle("Fit Peaks");
	...
	private void display() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Gaussian fit", "Placeholder Fit"}));
